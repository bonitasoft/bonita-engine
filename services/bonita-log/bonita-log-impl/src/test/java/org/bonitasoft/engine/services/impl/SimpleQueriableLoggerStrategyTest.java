...
public class SimpleQueriableLoggerStrategyTest {
    ...
    @Test
    public void isLogable_shoud_return_false_if_system_property_queryablelogDisable_is_null() throws Exception {
    ...
    @Test
    public void isLogable_shoud_return_true_if_system_property_queryablelogDisable_is_not_null() throws Exception {
        SimpleQueriableLoggerStrategy strategy = new SimpleQueriableLoggerStrategy();
