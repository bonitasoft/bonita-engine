...
public class Narayana5BonitaTransactionManagerLookup implements BonitaTransactionManagerLookup {

    private TransactionManager transactionManager;

    public Narayana5BonitaTransactionManagerLookup() throws Exception {
