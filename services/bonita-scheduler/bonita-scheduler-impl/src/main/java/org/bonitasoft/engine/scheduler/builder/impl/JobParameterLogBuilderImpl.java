 ...
 */
public class JobParameterLogBuilderImpl extends CRUDELogBuilder implements JobParameterLogBuilder {
    ...
    @Override
    public JobParameterLogBuilder jogDescriptorId(final long jobDescriptorId) {
