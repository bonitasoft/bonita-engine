...
public class JobObservableExecutor implements ObservableExecutor {
    ...
    public JobObservableExecutor(Long tenantId,
                                 MonitoringJobListener monitoringJobListener) {
    ...
    public long getRunnings() {
        return monitoringJobListener.getNumberOfExecutingJobs(tenantId);
    }

    @Override
    public long getExecuted() {
        return monitoringJobListener.getNumberOfExecutedJobs(tenantId);
    }
}
