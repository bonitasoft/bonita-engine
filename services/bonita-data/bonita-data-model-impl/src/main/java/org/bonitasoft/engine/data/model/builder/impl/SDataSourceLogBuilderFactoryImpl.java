 ...
 */
public class SDataSourceLogBuilderFactoryImpl extends CRUDELogBuilderFactory implements SDataSourceLogBuilderFactory {
    
    @Override
    public SDataSourceLogBuilder createNewInstance() {
