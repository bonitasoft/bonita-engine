...
public class SDataInstanceVisibilityMappingBuilderImpl implements SDataInstanceVisibilityMappingBuilder {
    ...
    @Override
    public SDataInstanceVisibilityMappingBuilder createNewInstance(final long containerId, final String containerType, final String dataName,
            final long dataInstanceId) {
        entity = new SDataInstanceVisibilityMappingImpl(containerId, containerType, dataName, dataInstanceId);
        return this;
    }
