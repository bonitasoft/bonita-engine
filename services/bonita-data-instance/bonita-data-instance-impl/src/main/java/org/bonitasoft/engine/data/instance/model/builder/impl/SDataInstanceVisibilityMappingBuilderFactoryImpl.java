...
public class SDataInstanceVisibilityMappingBuilderFactoryImpl implements SDataInstanceVisibilityMappingBuilderFactory {
    ...
    @Override
    public SDataInstanceVisibilityMappingBuilder createNewInstance(
            long containerId, String containerType, String dataName,
            long dataInstanceId) {
        final SDataInstanceVisibilityMappingImpl entity = new SDataInstanceVisibilityMappingImpl(containerId, containerType, dataName, dataInstanceId);
        return new SDataInstanceVisibilityMappingBuilderImpl(entity);
    }
}
