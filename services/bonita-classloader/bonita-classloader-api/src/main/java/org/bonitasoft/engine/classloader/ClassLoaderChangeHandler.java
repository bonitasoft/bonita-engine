 ...
 * {@link ClassLoaderService#addClassLoaderChangeHandler(LocalClassLoaderIdentifier, ClassLoaderChangeHandler)}
 * 
...
public interface ClassLoaderChangeHandler {
    ...
    /**
     * Executes an action when the ClassLoader is destroyed.
