 ...
 */
public class SPlatformDependencyBuilder implements DependencyBuilder {

    private SPlatformDependency object;

    @Override
    public DependencyBuilder createNewInstance(final String name, final String version, final String fileName, final byte[] value) {
        object = new SPlatformDependency(name, version, fileName, value);
        return this;
    }
