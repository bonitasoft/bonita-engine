...
public class DataInstanceServiceImplIT extends DataInstanceServiceTest {
    ...
    public static void setupImplementation() {
        ...
        SEventBuilders sEventBuilders = getServicesBuilder().getInstanceOf(SEventBuilders.class);
        ArchiveService archiveService = getServicesBuilder().buildArchiveService();
        dataInstanceServiceImpl = new DataInstanceServiceImpl(dataSourceService, dataInstanceBuilders, recorder, sEventBuilders, persistenceService,
                archiveService, technicalLoggerService);
    }
    ...
    public void shouldBeAbleToInsertSameDataVisibilityOnDifferentTenant() throws Exception {
        ...
        SDataInstanceVisibilityMapping mapping = dataInstanceBuilders.getDataInstanceVisibilityMappingBuilder()
