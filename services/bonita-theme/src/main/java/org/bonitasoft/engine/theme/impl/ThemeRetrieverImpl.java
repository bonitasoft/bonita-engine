...
public class ThemeRetrieverImpl implements ThemeRetriever {
    ...
    @Override
    public STheme getTheme(final SThemeType type, final boolean isDefault) throws SBonitaReadException {
        return persistenceService.selectOne(SelectDescriptorBuilder.getTheme(type, isDefault));
    }
