...
public class SThemeException extends SBonitaException {
    ...
    public SThemeException(final String message) {
        super(message);
    }

    public SThemeException(final Throwable cause) {
        super(cause);
    }

    public SThemeException(final String message, final Throwable cause) {
        super(message, cause);
    }
