 ...
 */
public class SProfileLogBuilder extends CRUDELogBuilder implements SPersistenceLogBuilder {
    ...
    public SPersistenceLogBuilder objectId(final long objectId) {
        queriableLogBuilder.numericIndex(PROFILE_INDEX, objectId);
        return this;
    }
    ...
    protected void checkExtraRules(final SQueriableLog log) {
        if (log.getActionStatus() != SQueriableLog.STATUS_FAIL && log.getNumericIndex(PROFILE_INDEX) == 0L) {
