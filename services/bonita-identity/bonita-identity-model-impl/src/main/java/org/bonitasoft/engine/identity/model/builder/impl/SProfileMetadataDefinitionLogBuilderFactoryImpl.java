 ...
 */
public class SProfileMetadataDefinitionLogBuilderFactoryImpl extends CRUDELogBuilderFactory implements SProfileMetadataDefinitionLogBuilderFactory {
    ...
    @Override
    public SProfileMetadataDefinitionLogBuilder createNewInstance() {
