...
import static org.bonitasoft.engine.platform.model.impl.SPlatformAssert.assertThat;

import org.junit.Test;

public class SPlatformTest {

    @Test
    public void should_create_consistent_platform() throws Exception {
        //given
        long created = System.currentTimeMillis();
        SPlatform platform = new SPlatform("7.0", "6.5", "6.4", "admin", created);
