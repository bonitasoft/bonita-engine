...
set ARJUNA_OPTS="-Dcom.arjuna.ats.arjuna.objectstore.objectStoreDir=${CATALINA_HOME}/temp/tx-object-store -Dcom.arjuna.ats.arjuna.coordinator.defaultTimeout=180"
