...
-Dsysprop.bonita.hibernate.transaction.jta_platform=org.bonitasoft.engine.persistence.Narayana5HibernateJtaPlatform \
-Dsysprop.bonita.transaction.manager=java:comp/env/TransactionManager"
