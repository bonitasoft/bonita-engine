...
set ARJUNA_OPTS="-Dcom.arjuna.ats.arjuna.objectstore.objectStoreDir=${CATALINA_HOME}/temp/tx-object-store -Dcom.arjuna.ats.arjuna.coordinator.defaultTimeout=180 -Dsysprop.bonita.hibernate.transaction.jta_platform=org.bonitasoft.engine.persistence.Narayana5HibernateJtaPlatform -Dsysprop.bonita.transaction.manager=java:comp/env/TransactionManager"
