...
public class PlatformAPIExt extends PlatformAPIImpl implements PlatformAPI {
    ...
    private long create(final TenantCreator creator) throws CreationException {
        ...
        try {
            ...
            BonitaHomeServer.getInstance().getTenantManager().modifyTechnicalUser(tenant.getId(), userName, password);
            ...
            if (bhTenantCreated) {
                try {
                    BonitaHomeServer.getInstance().getTenantManager().deleteTenant(tenantId);
                } catch (Exception e1) {
    ...
    public Tenant updateTenant(final long tenantId, final TenantUpdater udpater) throws UpdateException {
        ...
        try {
            ...
            if (username != null || password != null) {
                BonitaHomeServer.getInstance().getTenantManager().modifyTechnicalUser(tenantId, username, password);
            }
