...
public class BDRepositoryIT extends CommonAPISPIT {
    ...
    public void shouldBeAbleToRunDAOCallThroughGroovy() throws Exception {
        ...
        processDefinitionBuilder.addAutomaticTask("auto1")
                ...
                .addOperation(new LeftOperandBuilder().createBusinessDataLeftOperand(bizDataName), OperatorType.ASSIGNMENT, null, null, employee1Expression);
        ...
        expressions.put(
                new ExpressionBuilder().createGroovyScriptExpression(getLastNameWithDAOExpression, "import " + EMPLOYEE_QUALIFIED_NAME + "; Employee e = "
                        + employeeDAOName + ".findByFirstName('" + firstNameEmployee1 + "', 0, 10).get(0); e.getAddresses().get(0).city",
                        String.class.getName(),
    ...
    public void should_use_apiClient_to_instantiate_dao_on_client_side() throws Exception {
        ...
        try {
            ...
            @SuppressWarnings("unchecked")
            final Class<? extends org.bonitasoft.engine.bdm.dao.BusinessObjectDAO> daoInterface = (Class<? extends org.bonitasoft.engine.bdm.dao.BusinessObjectDAO>) Class.forName(EMPLOYEE_QUALIFIED_NAME + "DAO", true,
                    classLoaderWithBDM);
            final APIClient client_sp = new APIClient(apiSession);
            final BusinessObjectDAO daoImpl = client_sp.getDAO(daoInterface);
    ...
    public void shouldBeAbleToCreate2BusinessDataUsingIntermixedBizDataJavaSetterOperations() throws Exception {
        ...
        final Expression createNewAddressExpression = new ExpressionBuilder().createGroovyScriptExpression("createNewAddress",
                ...
                ADDRESS_QUALIFIED_NAME);
        final Expression createNewCountryExpression = new ExpressionBuilder().createGroovyScriptExpression("createNewCountry", "import "
                + COUNTRY_QUALIFIED_NAME
                + "; Country c = new Country(name:'France'); c;",
                COUNTRY_QUALIFIED_NAME);
    ...
    @Test
    public void getProcessBusinessDataReferencesShouldReturnTheListOfReferences() throws Exception {
        final String taskName = "step";
        final ProcessDefinition definition = buildProcessThatUpdateBizDataInsideConnector(taskName);
        final ProcessInstance instance = getProcessAPI().startProcess(definition.getId());
        waitForUserTask(instance, taskName);
    ...
    public void getBusinessDataCommand_should_return_json_entities() throws Exception {
        ...
        final Expression addressExpression = new ExpressionBuilder().createGroovyScriptExpression("createNewAddress",
                ...
                ADDRESS_QUALIFIED_NAME, new ExpressionBuilder().createBusinessDataExpression("myCountry", COUNTRY_QUALIFIED_NAME));
        ...
        final org.bonitasoft.engine.business.data.SimpleBusinessDataReference businessDataReference = (org.bonitasoft.engine.business.data.SimpleBusinessDataReference) getBusinessDataAPI()
                .getProcessBusinessDataReference(bizDataName,
    ...
    private void verifyCommandGetBusinessDataById(final org.bonitasoft.engine.business.data.SimpleBusinessDataReference businessDataReference)
            throws Exception {
    ...
    private void verifyCommandGetQuery_getEmployeeByPhoneNumber() throws Exception {
        ...
        // then
        assertThatJson(businessDataQueryResult.getJsonResults()).as("should get employee").hasSameStructureAs(getJsonContent("getEmployeeByPhoneNumber.json"));
    ...
    private String getClientBdmJarClassPath(final String bonitaHomePath) {
        ...
        clientBdmJarPath = new StringBuilder().append(bonitaHomePath).append(File.separator).append("engine-server").append(File.separator).append("work")
                .append(File.separator).append("tenants")
    ...
    public void should_execute_a_connector_with_tenant_dependency() throws Exception {
        ...
        final BusinessObjectModel businessObjectModel = aBOM()
