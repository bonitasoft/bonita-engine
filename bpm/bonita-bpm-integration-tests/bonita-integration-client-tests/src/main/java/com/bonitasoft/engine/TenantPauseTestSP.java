...
public class TenantPauseTestSP extends CommonAPISPTest {
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(TenantPauseTestSP.class);
    ...
    public void twoTenantPauseMode() throws Exception {
        ...
        TenantParameter tenant1 = createTenant("TenantPauseTestSP2");
        TenantParameter tenant2 = createTenant("TenantPauseTestSP3");
