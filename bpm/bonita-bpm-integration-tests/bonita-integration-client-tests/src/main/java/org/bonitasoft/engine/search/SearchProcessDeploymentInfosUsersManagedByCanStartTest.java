...
public class SearchProcessDeploymentInfosUsersManagedByCanStartTest extends CommonAPITest {
    ...
    public void searchProcessDefinitionsUsersManagedByCanStart() throws Exception {
        ...
        SearchResult<ProcessDeploymentInfo> searchRes = getProcessAPI().searchProcessDeploymentInfosUsersManagedByCanStart(users.get(8).getId(),
    ...
    private void createProcessesDefForSearchProcessUserCanStart() throws BonitaException {
        ...
        final ProcessDefinition processDefinition1 = deployAndEnableWithActor(designProcessDefinition1, actor1, users.get(3));
