...
public class PageQueriesTest {
    ...
    public void getPageContent_should_return_the_content_of_the_page() throws Exception {
        // given
        SPage page = repository.add(aPage().withName("MyPage").withContent("The content".getBytes()).build());
        //
        // //when
        SPageContent pageContent = repository.getPageContent(page.getId());
        // //then
    ...
    public void getPageByName_should_return_the_page_having_the_name() throws Exception {
        ...
        SPage page2 = repository.add(aPage().withName("MyPage2").withContent("The content".getBytes()).build());
        //
        // //when
        SPage pageByName = repository.getPageByName("MyPage2");
