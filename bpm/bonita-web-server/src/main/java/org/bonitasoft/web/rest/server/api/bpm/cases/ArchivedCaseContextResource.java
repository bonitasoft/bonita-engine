...
public class ArchivedCaseContextResource extends CommonResource {
    ...
    @Get("json")
    public Map<String, Serializable> getArchivedCaseContext()
        ...
        Map<String, Serializable> caseExecutionContext = processAPI
                .getArchivedProcessInstanceExecutionContext(getArchivedCaseIdParameter());
    ...
    protected long getArchivedCaseIdParameter() {
        ...
        if (caseId == null) {
            throw new APIException(
                    "Attribute '" + ARCHIVED_CASE_ID + "' is mandatory in order to get the archived case context");
        }
