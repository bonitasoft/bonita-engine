 ...
 */
public class TimerEventTriggerDefinitionBinding extends ElementBinding {

    private TimerType timerType;

    private Expression timerExpression;

    public TimerEventTriggerDefinitionBinding() {
        super();
    }
    ...
    public String getElementTag() {
        return XMLProcessDefinition.TIMER_EVENT_TRIGGER_NODE;
    }
