...
public class FlowElementContainerDefinitionImplUptoEventDefTestClass extends BaseElementImpl implements FlowElementContainerDefinition, Visitable {
    ...
    private List<StartEventDefinition> startEvents;
    ...
    private List<IntermediateCatchEventDefinition> intermediateCatchEvents;
    ...
    private List<IntermediateThrowEventDefinition> intermediateThrowEvents;
    @XmlElementWrapper(name = "endEvents")
    @XmlElement(type = EndEventDefinitionImpl.class, name = "endEvent")
    private List<EndEventDefinition> endEvents;

    public FlowElementContainerDefinitionImplUptoEventDefTestClass(List<ActivityDefinition> activities, Set<TransitionDefinition> transitions) {
    ...
    public FlowElementContainerDefinitionImplUptoEventDefTestClass() {
    ...
    public void setIntermediateCatchEvents(List<IntermediateCatchEventDefinition> list){
        this.intermediateCatchEvents = list;
    }
    public void setIntermediateThrowEvents(List<IntermediateThrowEventDefinition> list){
        this.intermediateThrowEvents = list;
    }
    public void setEndEvents(List<EndEventDefinition> list){
        this.endEvents = list;
    }
    public void setStartEvents(List<StartEventDefinition> se) {
        this.startEvents = se;
    }
