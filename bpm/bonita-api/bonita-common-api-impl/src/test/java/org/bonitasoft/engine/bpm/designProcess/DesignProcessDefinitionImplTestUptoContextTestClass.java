...
public class DesignProcessDefinitionImplTestUptoContextTestClass extends ProcessDefinitionImpl implements DesignProcessDefinition, Visitable {
    ...
    */
    ...
    public DesignProcessDefinitionImplTestUptoContextTestClass(final String name, final String version) {
        super(name, version);
        parameters = new HashSet<>();
        actors = new ArrayList<>();
    }
    public DesignProcessDefinitionImplTestUptoContextTestClass(){
        super();
        parameters = new HashSet<>();
        actors = new ArrayList<>();
    }
    ...
    public void setContract(ContractDefinitionImpl contract) {
