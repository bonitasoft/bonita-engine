...
public class DesignProcessDefinitionImplTestUptoContractTestClass extends ProcessDefinitionImpl implements DesignProcessDefinition, Visitable {
    ...
    private ContractDefinition contract = null;
     ...
     */
    public DesignProcessDefinitionImplTestUptoContractTestClass(final String name, final String version) {
        super(name, version);
        parameters = new HashSet<>();
        actors = new ArrayList<>();
    }

    public DesignProcessDefinitionImplTestUptoContractTestClass() {
        super();
        parameters = new HashSet<>();
        actors = new ArrayList<>();
    }
