...
public class FlowElementContainerDefinitionImplUptoTransitionsTestClass extends BaseElementImpl implements FlowElementContainerDefinition, Visitable {
    ...
    public FlowElementContainerDefinitionImplUptoTransitionsTestClass(List<ActivityDefinition> activities, Set<TransitionDefinition> transitions) {
        this.activities = activities;
        this.transitions = transitions;
    }

    public FlowElementContainerDefinitionImplUptoTransitionsTestClass() {
