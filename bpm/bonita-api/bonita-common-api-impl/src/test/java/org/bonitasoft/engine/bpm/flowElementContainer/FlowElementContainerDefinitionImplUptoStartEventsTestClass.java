...
public class FlowElementContainerDefinitionImplUptoStartEventsTestClass extends BaseElementImpl implements FlowElementContainerDefinition, Visitable {
    ...
    public FlowElementContainerDefinitionImplUptoStartEventsTestClass(List<ActivityDefinition> activities, Set<TransitionDefinition> transitions) {
    ...
    public FlowElementContainerDefinitionImplUptoStartEventsTestClass() {
