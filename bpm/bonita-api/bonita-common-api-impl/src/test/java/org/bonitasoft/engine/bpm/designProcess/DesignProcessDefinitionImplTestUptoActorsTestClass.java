...
public class DesignProcessDefinitionImplTestUptoActorsTestClass extends ProcessDefinitionImpl implements DesignProcessDefinition, Visitable {
...
*/
    public DesignProcessDefinitionImplTestUptoActorsTestClass(final String name, final String version) {
        super(name, version);
        parameters = new HashSet<>();
        actors = new ArrayList<>();
    }
    public DesignProcessDefinitionImplTestUptoActorsTestClass(){
        super();
        parameters = new HashSet<>();
        actors = new ArrayList<>();
    }
    ...
    public boolean equals(Object o) {
        ...
        DesignProcessDefinitionImplTestUptoActorsTestClass that = (DesignProcessDefinitionImplTestUptoActorsTestClass) o;
    ...
    public String toString() {
        return "DesignProcessDefinitionImplTestUptoActorsTestClass{" +
