...
public abstract class ElementBinding {
    ...
    public abstract void setAttributes(final Map<String, String> attributes) throws XMLParseException;

    public abstract void setChildElement(final String name, final String value, final Map<String, String> attributes) throws XMLParseException;

    public abstract void setChildObject(final String name, final Object value) throws XMLParseException;
