 ...
 * 
 * The class ArchivedDocumentNotFoundException are a form of Throwable that indicates conditions that a reasonable application might want to catch.
 * The class ArchivedDocumentNotFoundException that are not also subclasses of {@link RuntimeException} are checked exceptions.
