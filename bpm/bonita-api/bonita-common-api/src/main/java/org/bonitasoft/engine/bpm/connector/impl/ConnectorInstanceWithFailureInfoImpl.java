...
public class ConnectorInstanceWithFailureInfoImpl extends ConnectorInstanceImpl implements ConnectorInstanceWithFailureInfo {
    ...
    public ConnectorInstanceWithFailureInfoImpl(String name, long containerId, String containerType, String connectorId, String version, ConnectorState state,
            ConnectorEvent activationEvent, String exceptionMessage, String stackTrace) {
