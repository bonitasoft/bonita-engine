 ...
 * 
 * The class UserTaskNotFoundException are a form of Throwable that indicates conditions that a reasonable application might want to catch.
 * The class UserTaskNotFoundException that are not also subclasses of {@link RuntimeException} are checked exceptions.
