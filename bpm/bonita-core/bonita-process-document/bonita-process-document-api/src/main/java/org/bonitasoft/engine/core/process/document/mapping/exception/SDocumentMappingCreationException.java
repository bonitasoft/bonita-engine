...
public class SDocumentMappingCreationException extends SDocumentMappingException {
    ...
    public SDocumentMappingCreationException(final String message, final Throwable cause) {
        super(message, cause);
    }

    public SDocumentMappingCreationException(final String message) {
        super(message);
    }

    public SDocumentMappingCreationException(final Throwable cause) {
        super(cause);
    }
