...
public class SPageLogBuilderImpl extends CRUDELogBuilder implements SPageLogBuilder {
    ...
    public SPersistenceLogBuilder objectId(final long objectId) {
        queriableLogBuilder.numericIndex(SPageLogBuilderFactoryImpl.REPORT_INDEX, objectId);
        return this;
    }
    ...
    protected void checkExtraRules(final SQueriableLog log) {
        if (log.getActionStatus() != SQueriableLog.STATUS_FAIL && log.getNumericIndex(SPageLogBuilderFactoryImpl.REPORT_INDEX) == 0L) {
