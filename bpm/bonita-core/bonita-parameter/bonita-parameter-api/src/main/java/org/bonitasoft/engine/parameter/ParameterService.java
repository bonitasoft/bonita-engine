...
public interface ParameterService {
    ...
    void addAll(final long processDefinitionId, final Map<String, String> parameters)
            throws SParameterProcessNotFoundException, SObjectCreationException, SBonitaReadException, SObjectModificationException;

    /**
     * Return all parameters for a given process definition
     * 
     * @param processDefinitionId the ID of the process definition from which to retrieve the parameters
     */
