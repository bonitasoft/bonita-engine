 ...
 */
public class SHiddenTaskInstanceBuilderFactoryImpl implements SHiddenTaskInstanceBuilderFactory {
    ...
    @Override
    public SHiddenTaskInstanceBuilder createNewInstance(final long activityId, final long userId) {
        final SHiddenTaskInstanceImpl entity = new SHiddenTaskInstanceImpl(activityId, userId);
        return new SHiddenTaskInstanceBuilderImpl(entity);
    }
