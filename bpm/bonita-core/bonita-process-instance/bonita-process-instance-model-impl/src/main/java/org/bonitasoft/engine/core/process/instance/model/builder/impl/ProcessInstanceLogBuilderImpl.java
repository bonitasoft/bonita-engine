 ...
 */
public class ProcessInstanceLogBuilderImpl extends CRUDELogBuilder implements ProcessInstanceLogBuilder {

    private static final String PROCESS_INSTANCE = "PROCESS_INSTANCE";

    @Override
    public SPersistenceLogBuilder objectId(final long objectId) {
        this.queriableLogBuilder.numericIndex(ProcessInstanceLogIndexesMapper.PROCESS_INSTANCE_INDEX, objectId);
        return this;
    }
