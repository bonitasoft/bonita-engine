...
public class SBoundaryEventInstanceImplTest {
    ...
    @Test
    public void mustExecutOnAbortOrCancelProcess_return_false_if_stable() throws Exception {
    ...
    @Test
    public void mustExecutOnAbortOrCancelProcess_return_false_if_not_stable() throws Exception {
