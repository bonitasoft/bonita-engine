 ...
 */
public class SManualTaskInstanceImpl extends SHumanTaskInstanceImpl implements SManualTaskInstance {

    private static final long serialVersionUID = -3537435744421627183L;

    protected SManualTaskInstanceImpl() {
    }

    public SManualTaskInstanceImpl(final String name, final long flowNodeDefinitionId, final long rootContainerId, final long parenteContainerId,
