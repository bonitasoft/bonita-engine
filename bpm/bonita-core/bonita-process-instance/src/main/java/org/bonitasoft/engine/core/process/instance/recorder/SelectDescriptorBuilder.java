...
public class SelectDescriptorBuilder {
    ...
    public static SelectListDescriptor<SAFlowNodeInstance> getArchivedFlowNodesFromProcessInstance(final long rootContainerId, final int fromIndex,
        ...
        final QueryOptions queryOptions = new QueryOptions(fromIndex, maxResults);
        return new SelectListDescriptor<>("getArchivedFlowNodesFromProcessInstance", parameters, SAFlowNodeInstance.class, queryOptions);
    }

    public static SelectListDescriptor<SAActivityInstance> getArchivedActivitiesFromProcessInstance(final long rootContainerId,
            final QueryOptions queryOptions) {
        final Map<String, Object> parameters = Collections.singletonMap("rootContainerId", (Object) rootContainerId);
        return new SelectListDescriptor<>("getAActivitiesFromProcessInstance", parameters, SAActivityInstance.class, queryOptions);
    }
    ...
    public static SelectListDescriptor<SHumanTaskInstance> getPendingUserTasks(final long userId, final int fromIndex, final int maxResults,
        ...
        parameters.put("userId", userId);
        final QueryOptions queryOptions = new QueryOptions(fromIndex, maxResults, SActivityInstance.class, sortFieldName, order);
        return new SelectListDescriptor<>("getPendingUserTasksWithoutActorIds", parameters, SHumanTaskInstance.class, queryOptions);
    }
    ...
    public static SelectOneDescriptor<Long> getNumberOfArchivedProcessInstances() {
        final Map<String, Object> emptyMap = Collections.emptyMap();
        return new SelectOneDescriptor<>("getNumberOfArchivedProcessInstances", emptyMap, SAProcessInstance.class, Long.class);
    }
    ...
    public static SelectOneDescriptor<Long> getNumberOfAssignedHumanTaskInstances(final long userId) {
        final Map<String, Object> parameters = Collections.singletonMap("assigneeId", (Object) userId);
        return new SelectOneDescriptor<>("getNumberOfAssignedUserTaskInstances", parameters, SHumanTaskInstance.class, Long.class);
    }
    ...
    public static SelectListDescriptor<SActivityInstance> getActivitiesFromProcessInstance(final long rootContainerId, final int fromIndex,
        ...
        final Map<String, Object> parameters = Collections.singletonMap("rootContainerId", (Object) rootContainerId);
        final QueryOptions queryOptions = new QueryOptions(fromIndex, maxResults);
        return new SelectListDescriptor<>("getActivitiesFromProcessInstance", parameters, SActivityInstance.class, queryOptions);
    }

    public static SelectOneDescriptor<Long> getNumberOfActivitiesFromProcessInstance(final long rootContainerId) {
        final Map<String, Object> parameters = Collections.singletonMap("rootContainerId", (Object) rootContainerId);
        return new SelectOneDescriptor<>("getNumberOfActivitiesFromProcessInstance", parameters, SFlowNodeInstance.class, Long.class);
    }
    ...
    public static SelectListDescriptor<SEventInstance> getEventsFromRootContainer(final long rootContainerId, final int fromIndex, final int maxResults,
        ...
        return new SelectListDescriptor<>("getEventInstancesFromRootContainer", parameters, SEventInstance.class, queryOptions);
    }
    ...
    public static SelectOneDescriptor<Long> getNumberOfChildInstancesOfProcessInstance(final long processInstanceId) {
        ...
        return new SelectOneDescriptor<>("getNumberOfChildInstancesOfProcessInstance", parameters, SProcessInstance.class, Long.class);
    }
    ...
    public static SelectListDescriptor<SWaitingErrorEvent> getCaughtError(final long relatedActivityInstanceId, final QueryOptions queryOptions) {
        ...
        return new SelectListDescriptor<>("getCaughtErrorByRelatedActivityAndAnyErrorCode", parameters, SWaitingErrorEvent.class,
                queryOptions);
    }
    ...
    public static SelectListDescriptor<SWaitingErrorEvent> getCaughtError(final long relatedActivityInstanceId, final String errorCode,
        ...
        return new SelectListDescriptor<>("getCaughtErrorByRelatedActivityAndErrorCode", parameters, SWaitingErrorEvent.class, queryOptions);
    }
    ...
    public static SelectListDescriptor<SMessageEventCouple> getMessageEventCouples(final int fromIndex, final int maxResults) {
        final Map<String, Object> parameters = Collections.emptyMap();
        final QueryOptions queryOptions = new QueryOptions(fromIndex, maxResults);
        return new SelectListDescriptor<>("getMessageEventCouples", parameters, SMessageEventCouple.class, queryOptions);
    }

    public static SelectOneDescriptor<SAActivityInstance> getArchivedActivityInstanceWithActivityIdAndStateId(final long activityInstanceId,
            final int stateId) {
        final Map<String, Object> parameters = new HashMap<>(2);
        parameters.put("activityInstanceId", activityInstanceId);
        parameters.put("stateId", stateId);
        return new SelectOneDescriptor<>("getAActivityInstanceByActivityInstanceIdAndStateId", parameters, SAActivityInstance.class);
    }
    ...
    public static SelectListDescriptor<Map<String, Long>> getNumbersOfAssignedOpenTasks(final List<Long> userIds) {
        ...
        return new SelectListDescriptor<>("getNumbersOfOpenTasksForUsers", parameters, SHumanTaskInstance.class, queryOptions);
    }
    ...
    public static SelectListDescriptor<Map<Long, Long>> getNumbersOfAssignedOverdueOpenTasks(final List<Long> userIds) {
        ...
        return new SelectListDescriptor<>("getNumbersOfAssignedOverdueTasksForUsers", parameters, SHumanTaskInstance.class, queryOptions);
    }
