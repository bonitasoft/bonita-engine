...
public class QueryPreProcessorTest {
    ...
    @Test
    public void should_replace_boolean_value_for_oracle() throws Exception {
    ...
    @Test
    public void should_replace_boolean_value_for_sqlserver() throws Exception {
        String queryString = "SELECT * FROM TASK WHERE DELETED =  false";
        String expectedQueryString = "SELECT * FROM TASK WHERE DELETED = 0";
    ...
    @Test
    public void should_do_nothing_for_other_databases_vendors() throws Exception {
