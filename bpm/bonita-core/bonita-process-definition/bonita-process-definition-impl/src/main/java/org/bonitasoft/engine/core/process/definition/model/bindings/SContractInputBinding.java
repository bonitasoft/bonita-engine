 ...
 */
public class SContractInputBinding extends SNamedElementBinding {
    ...
    public Object getObject() {
        return new XMLSProcessDefinition.BEntry<>(name, expression);
    }

    @Override
    public String getElementTag() {
        return XMLSProcessDefinition.CONTRACT_INPUT_EXPRESSION_NODE;
    }
