...
public class SSimpleInputDefinitionImplTest {
    ...
    public void contructor_with_name() throws Exception {
        //given
        final SSimpleInputDefinitionImpl sInputDefinitionImpl = new SSimpleInputDefinitionImpl(NAME, SType.TEXT, DESCRIPTION);
    ...
    public void constructor_with_input_definition() throws Exception {
        ...
        //when
        final SSimpleInputDefinitionImpl sInputDefinitionImpl = new SSimpleInputDefinitionImpl(simpleInput);
