...
public interface ProcessDefinitionService {
     ...
     * @throws SProcessDefinitionReadException
     */
    long getLatestProcessDefinitionId(String processName) throws SProcessDefinitionReadException;
     ...
     */
    void updateProcessDefinitionDeployInfo(long processId, EntityUpdateDescriptor descriptor) throws SProcessDefinitionNotFoundException,
     ...
     * @throws SBonitaSearchException
     */
    List<SProcessDefinitionDeployInfo> searchProcessDeploymentInfos(long userId, QueryOptions searchOptions) throws SBonitaSearchException;
     ...
     * @throws SBonitaSearchException
     */
    long getNumberOfProcessDeploymentInfos(long userId, QueryOptions countOptions) throws SBonitaSearchException;
     ...
     * @throws SBonitaSearchException
     */
    List<SProcessDefinitionDeployInfo> searchProcessDeploymentInfosUsersManagedByCanStart(long managerUserId, QueryOptions searchOptions)
            throws SBonitaSearchException;
     ...
     * @throws SBonitaSearchException
     */
    long getNumberOfProcessDeploymentInfosUsersManagedByCanStart(long managerUserId, QueryOptions countOptions) throws SBonitaSearchException;
     ...
     * @throws SBonitaSearchException
     */
    List<SProcessDefinitionDeployInfo> searchUncategorizedProcessDeploymentInfosUserCanStart(long userId, QueryOptions searchOptions)
            throws SBonitaSearchException;
     ...
     * @throws SBonitaSearchException
     */
    long getNumberOfUncategorizedProcessDeploymentInfosUserCanStart(long userId, QueryOptions countOptions) throws SBonitaSearchException;
     ...
     * @return A list of SProcessDefinitionDeployInfo
     * @throws SBonitaSearchException
     */
    List<Map<String, String>> getProcessDeploymentInfosFromProcessInstanceIds(List<Long> processInstanceIds) throws SBonitaSearchException;
     ...
     * @throws SBonitaSearchException
     */
    long getNumberOfUsersWhoCanStartProcessDeploymentInfo(long processDefinitionId, QueryOptions searchOptions) throws SBonitaSearchException;
     ...
     * @throws SBonitaSearchException
     */
    List<SUser> searchUsersWhoCanStartProcessDeploymentInfo(long processDefinitionId, QueryOptions searchOptions) throws SBonitaSearchException;
