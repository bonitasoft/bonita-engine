...
public class SSubProcessDefinitionImplTest {
    ...
    @Test
    public void isStartable_return_false_if_sub_process_is_triggered_by_event() throws Exception {
        assertFalse(subProcessTriggeredByEvent.isStartable());
    }

    @Test
    public void isStartable_return_false_if_sub_process_has_incoming_transitions() throws Exception {
    ...
    @Test
    public void isStartable_return_true_if_sub_process_has_no_incoming_transitions_and_is_not_triggered_by_event() throws Exception {
