...
public class SStartEventDefinitionImplTest {
    ...
    @Test
    public void isStartable_return_false_if_start_event_has_trigger_events() throws Exception {
    ...
    @Test
    public void isStartable_return_false_if_start_event_has_incoming_transitions() throws Exception {
    ...
    @Test
    public void isStartable_return_true_if_start_event_has_no_incoming_transitions_and_no_trigger_events() throws Exception {
