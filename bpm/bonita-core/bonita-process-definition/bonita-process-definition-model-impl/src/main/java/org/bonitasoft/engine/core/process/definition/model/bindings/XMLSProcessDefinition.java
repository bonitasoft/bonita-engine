...
public class XMLSProcessDefinition {
    ...
    static final String XML_DATA_DEFINITION_NODE = "xmlDataDefinition";

    public static final String SUB_PROCESS = "subProcess";

    public static final String TRIGGERED_BY_EVENT = "triggeredByEvent";

    public HashMap<Object, String> objectToId = new HashMap<Object, String>();
    ...
    private void fillLeftOperandNode(final XMLNode rightOperandNode, final SLeftOperand sLeftOperand) {
        rightOperandNode.addAttribute(RIGHT_OPERAND_VARIABLE, sLeftOperand.getDataName());
    }

    private void createAndfillCorrelations(final XMLNode messageEventTriggerNode, final SMessageEventTriggerDefinition messageEventTrigger) {
        for (final SCorrelationDefinition correlation : messageEventTrigger.getCorrelations()) {
