 ...
 */
public class GetPage implements TransactionContentWithResult<SReport> {
    ...
    public GetPage(final TenantServiceAccessor accessor, final long reportId) {
        super();
        this.accessor = accessor;
        this.reportId = reportId;
    }

    public GetPage(final TenantServiceAccessor accessor, final String reportName) {
        super();
        this.accessor = accessor;
