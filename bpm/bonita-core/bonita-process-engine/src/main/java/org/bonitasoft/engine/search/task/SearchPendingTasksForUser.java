...
public class SearchPendingTasksForUser extends AbstractHumanTaskInstanceSearchEntity {
    ...
    public SearchPendingTasksForUser(final ActivityInstanceService activityInstanceService, final FlowNodeStateManager flowNodeStateManager,
            final SearchHumanTaskInstanceDescriptor searchEntitiesDescriptor, final long userId, final SearchOptions options, final boolean orAssignedToUser) {
