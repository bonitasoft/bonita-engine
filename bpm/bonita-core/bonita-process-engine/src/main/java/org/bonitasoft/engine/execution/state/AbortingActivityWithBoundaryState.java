...
@Component
public class AbortingActivityWithBoundaryState extends EndingActivityWithBoundaryState {

    public AbortingActivityWithBoundaryState(final StateBehaviors stateBehaviors) {
