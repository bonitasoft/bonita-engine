...
public class ContractValidator {
    ...
    public boolean isValid(final SContractDefinition contract, final Map<String, Object> variables) {
        ...
        if (comments.isEmpty()) {
            ...
            for (final SSimpleInputDefinition sInputDefinition : contract.getSimpleInputs()) {
    ...
    private SRuleDefinition createInputValidateTypeRule(final SSimpleInputDefinition sInputDefinition) {
    ...
    private String getRealType(final SSimpleInputDefinition sInputDefinition) {
        STypeConverter sTypeConverter;
        final SType type=sInputDefinition.getType();
        try {
    ...
    private void validateContract(final SContractDefinition contract, final Map<String, Object> variables) {
        ...
        for (final SInputDefinition input : contract.getSimpleInputs()) {
