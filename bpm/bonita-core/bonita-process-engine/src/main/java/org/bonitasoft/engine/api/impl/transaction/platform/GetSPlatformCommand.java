...
public class GetSPlatformCommand implements TransactionContentWithResult<SPlatformCommand> {
    ...
    public GetSPlatformCommand(final PlatformCommandService platformCommandService, final String platformCommandName) {
        this.platformCommandService = platformCommandService;
        this.platformCommandName = platformCommandName;
    }

    @Override
    public void execute() throws SBonitaException {
        sPlatformCommand = platformCommandService.getPlatformCommand(platformCommandName);
    }
