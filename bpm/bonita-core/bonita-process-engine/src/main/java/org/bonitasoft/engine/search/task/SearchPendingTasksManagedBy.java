 ...
 * @author Zhang Bole
 */
public class SearchPendingTasksManagedBy extends AbstractHumanTaskInstanceSearchEntity {

    private final ActivityInstanceService activityInstanceService;

    private final long managerUserId;

    public SearchPendingTasksManagedBy(final ActivityInstanceService activityInstanceService, final FlowNodeStateManager flowNodeStateManager,
    ...
    public long executeCount(final QueryOptions searchOptions) throws SBonitaReadException {
        return activityInstanceService.searchNumberOfPendingTasksManagedBy(managerUserId, searchOptions);
    }

    @Override
    public List<SHumanTaskInstance> executeSearch(final QueryOptions searchOptions) throws SBonitaReadException {
        return activityInstanceService.searchPendingTasksManagedBy(managerUserId, searchOptions);
    }
