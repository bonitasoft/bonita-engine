...
public class GetSCommands implements TransactionContentWithResult<List<SCommand>> {
    ...
    public GetSCommands(final CommandService commandService, final int startIndex, final int maxResults, final CommandCriterion sort) {
        super();
    ...
    public void execute() throws SBonitaException {
        ...
        commands = commandService.getAllCommands(startIndex, maxResults, sCommandCriterion);
    }
