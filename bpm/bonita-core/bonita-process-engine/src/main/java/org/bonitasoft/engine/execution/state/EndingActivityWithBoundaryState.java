...
public abstract class EndingActivityWithBoundaryState implements FlowNodeState {

    private final StateBehaviors stateBehaviors;

    public EndingActivityWithBoundaryState(final StateBehaviors stateBehaviors) {
        super();
