 ...
 */
public class RoleBinding extends ElementBinding {
    ...
    public String getElementTag() {
        return OrganizationMappingConstants.ROLE;
    }
