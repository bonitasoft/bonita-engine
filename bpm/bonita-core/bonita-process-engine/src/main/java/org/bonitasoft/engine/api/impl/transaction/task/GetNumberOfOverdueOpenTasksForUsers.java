...
public class GetNumberOfOverdueOpenTasksForUsers implements TransactionContentWithResult<Map<Long, Long>> {
    ...
    public GetNumberOfOverdueOpenTasksForUsers(final List<Long> userIds, final ActivityInstanceService activityInstanceService) {
    ...
    public void execute() throws SBonitaException {
        result = activityInstanceService.getNumberOfOverdueOpenTasksForUsers(userIds);
    }
