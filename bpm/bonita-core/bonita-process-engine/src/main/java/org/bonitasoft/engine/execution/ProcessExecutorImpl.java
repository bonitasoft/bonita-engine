...
public class ProcessExecutorImpl implements ProcessExecutor {
    ...
    public FlowNodeState executeFlowNode(final long flowNodeInstanceId, final SExpressionContext contextDependency, final List<SOperation> operations,
        ...
        return flowNodeExecutor.stepForward(flowNodeInstanceId, contextDependency, operations, processInstanceId, executerId, executerForId);
    }
    ...
    private SProcessInstance createProcessInstance(final SProcessDefinition sDefinition, final long starterId, final long starterForId,
        ...
        final SProcessInstanceBuilder processInstanceBuilder = BuilderFactory.get(SProcessInstanceBuilderFactory.class).createNewInstance(sDefinition)
                .setStartedBy(starterId).setStartedFor(starterForId).setCallerId(callerId, callerType)
    ...
    protected SProcessInstance createProcessInstance(final SProcessDefinition processDefinition, final long starterId, final long starterForId,
        ...
        if (callerInstance != null) {
            return createProcessInstance(processDefinition, starterId, starterForId, callerId, callerInstance.getType(),
                    callerInstance.getRootContainerId());
        }
        return createProcessInstance(processDefinition, starterId, starterForId, callerId, null, -1);
    }
    ...
    @Override
    public SProcessInstance start(final long starterId, final long starterForId, final List<SOperation> operations, final Map<String, Object> context,
        ...
        return start(starterId, starterForId, null, operations, context, connectorsWithInput, -1, selector);
    }

    @Override
    public SProcessInstance start(final long processDefinitionId, final long targetSFlowNodeDefinitionId, final long starterId, final long starterForId,
        ...
        try {
            ...
            return start(starterId, starterForId, expressionContext, operations, context, connectorsWithInput, callerId, selector);
    ...
    @Override
    public SProcessInstance start(final long starterId, final long starterForId, final SExpressionContext expressionContext,
        ...
        try {
            ...
            final SProcessInstance sProcessInstance = createProcessInstance(sProcessDefinition, starterId, starterForId, callerId);
