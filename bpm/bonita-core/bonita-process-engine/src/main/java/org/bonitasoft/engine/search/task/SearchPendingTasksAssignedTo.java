...
public class SearchPendingTasksAssignedTo extends AbstractHumanTaskInstanceSearchEntity {

    private final ActivityInstanceService activityInstanceService;

    private final long userId;

    public SearchPendingTasksAssignedTo(final ActivityInstanceService activityInstanceService, final FlowNodeStateManager flowNodeStateManager,
    ...
    public long executeCount(final QueryOptions searchOptions) throws SBonitaReadException {
        return activityInstanceService.getNumberOfPendingTasksAssignedTo(userId, searchOptions);
    }

    @Override
    public List<SHumanTaskInstance> executeSearch(final QueryOptions searchOptions) throws SBonitaReadException {
        return activityInstanceService.searchPendingTasksAssignedTo(userId, searchOptions);
    }
