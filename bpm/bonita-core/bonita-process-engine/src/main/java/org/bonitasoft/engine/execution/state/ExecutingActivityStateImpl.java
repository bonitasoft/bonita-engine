 ...
 */
public class ExecutingActivityStateImpl extends FlowNodeStateWithConnectors {

    private final StateBehaviors stateBehaviors;

    public ExecutingActivityStateImpl(final StateBehaviors stateBehaviors) {
        super(stateBehaviors, false, true);
        this.stateBehaviors = stateBehaviors;
    }

    public ExecutingActivityStateImpl(final StateBehaviors stateBehaviors, final boolean onEnter, final boolean onFinish) {
        super(stateBehaviors, onEnter, onFinish);
        this.stateBehaviors = stateBehaviors;
    }
