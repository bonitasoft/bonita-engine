...
public class ImportDuplicateInOrganizationException extends SBonitaException {
    ...
    public ImportDuplicateInOrganizationException(final String message, final Throwable cause) {
        super(message, cause);
    }
    ...
    public ImportDuplicateInOrganizationException(final Throwable cause) {
        super(cause);
    }
