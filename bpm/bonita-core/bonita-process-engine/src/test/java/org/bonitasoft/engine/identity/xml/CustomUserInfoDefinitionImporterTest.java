...
public class CustomUserInfoDefinitionImporterTest {
    ...
    private CustomUserInfoDefinitionCreator skillsCreator = new CustomUserInfoDefinitionCreator(SKILLS_NAME, SKILLS_DESCRIPTION);

    private CustomUserInfoDefinitionCreator locationCreator = new CustomUserInfoDefinitionCreator(LOCATION_NAME);
