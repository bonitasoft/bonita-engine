...
public class FlowNodeDefinitionAndInstanceContextWorkTest {
    ...
    @Mock
    private ProcessInstanceContextWork wrappedWork;

    @Mock
    private FlowNodeDefinitionAndInstanceContextWork txBonitawork;
