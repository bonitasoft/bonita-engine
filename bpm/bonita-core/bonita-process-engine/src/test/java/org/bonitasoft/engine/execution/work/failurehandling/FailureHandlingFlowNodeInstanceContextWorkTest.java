...
public class FailureHandlingFlowNodeInstanceContextWorkTest {
    ...
    public void before() throws SFlowNodeNotFoundException, SFlowNodeReadException {
        txBonitawork = spy(new FailureHandlingFlowNodeInstanceContextWork(wrappedWork, FLOW_NODE_INSTANCE_ID));
