...
public class FailureHandlingProcessDefinitionAndInstanceContextWorkTest {
    ...
    private FailureHandlingProcessDefinitionAndInstanceContextWork txBonitawork;
    ...
    public void before() throws Exception {
        ...
        txBonitawork = spy(new FailureHandlingProcessDefinitionAndInstanceContextWork(wrappedWork, PROCESS_INSTANCE_ID));
