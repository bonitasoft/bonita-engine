...
public class ProfileEntryPermissionRuleTest {
    ...
    @Mock
    def Logger logger
    def ProfileEntryPermissionRule rule = new ProfileEntryPermissionRule()
    @Mock
    ...
    @Test
    public void should_check_with_resourceid_return_false() {
        doReturn(true).when(apiCallContext).isGET()
        doReturn("125").when(apiCallContext).getResourceId()
    ...
    public void should_check_verify_get_with_resource_user_is_in_profile() {
        doReturn(true).when(apiCallContext).isGET()
        doReturn([profile_id: "2"]).when(apiCallContext).getFilters()
