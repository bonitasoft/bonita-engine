...
public class ActivityDefinitionBuilder extends FlowElementContainerBuilder implements DescriptionBuilder {
     ...
     * are executed after calling the method <code>org.bonitasoft.engine.api.ProcessAPI#executeFlowNode(long)</code>
     *
     * @param leftOperand
     ...
     * <code>org.bonitasoft.engine.bpm.flownode.MultiInstanceLoopCharacteristics</code> using dataInput or dataOutput.
     *
