...
/**
 * It is used to map an <code>ActorInstance</code> with the organization.
 * It's possible to map an <code>ActorInstance</code> with a user, or a group, or a role, or a group and a role.
 *
