 ...
 */
public class PageMappingServiceIT extends CommonServiceTest {
    ...
    public PageMappingServiceIT() {
        super();
        ServicesBuilder servicesBuilder = CommonServiceTest.getServicesBuilder();
        transactionService = servicesBuilder.buildTransactionService();
        pageMappingService = servicesBuilder.buildPageMappingService();
    }
