...
public interface IdentityAnalyserTestAPI {
    ...
    void deleteUsers(final List<User> users) throws BonitaException;

    void deleteRoles(final List<Role> roles) throws BonitaException;

    void deleteGroups(final List<Group> groups) throws BonitaException;
