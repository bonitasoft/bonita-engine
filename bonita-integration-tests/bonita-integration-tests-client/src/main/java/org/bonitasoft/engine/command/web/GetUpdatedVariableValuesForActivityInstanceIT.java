 ...
 * @author Zhang Bole
 */
public class GetUpdatedVariableValuesForActivityInstanceIT extends TestWithTechnicalUser {
    ...
    @Cover(classes = CommandAPI.class, concept = BPMNConcept.ACTIVITIES, keywords = { "Command", "Updated variable value", "Activity instance",
            "Wrong parameter" }, story = "Execute get updated variable values for activity instance command with wrong parameter", jira = "ENGINE-586")
    @Test(expected = CommandParameterizationException.class)
    public void getUpdatedVariableValuesForActivityInstanceCommandWithWrongParameter() throws Exception {
        final Map<String, Serializable> parameters = new HashMap<String, Serializable>();
        parameters.put("BAD_KEY", "bad_value");

        getCommandAPI().execute("getUpdatedVariableValuesForActivityInstance", parameters);
    }
