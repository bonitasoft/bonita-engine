...
public class ErrorEventSubProcessIT extends AbstractWaitingEventIT {
    ...
    @Test
    public void should_catch_error_in_event_subprocess_when_process_is_disabled() throws Exception {
        ...
        long eventSubProcessTask = waitForUserTask("eventSubProcessTask");
        getProcessAPI().assignAndExecuteUserTask(user.getId(), eventSubProcessTask, Collections.emptyMap());
        waitForProcessToBeInState(processInstance, ProcessInstanceState.ABORTED);
