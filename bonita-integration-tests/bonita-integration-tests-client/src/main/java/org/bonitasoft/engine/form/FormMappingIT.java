...
public class FormMappingIT extends TestWithUser {
    ...
    public void deployProcessesWithFormMappingAndUpdateThem() throws Exception {
        ...
        BusinessArchiveBuilder bar2 = new BusinessArchiveBuilder()
                ...
                .setFormMappings(
                        FormMappingModelBuilder.buildFormMappingModel().addProcessStartForm("processStartForm", FormMappingTarget.INTERNAL)
                                .addTaskForm("task2Form", FormMappingTarget.INTERNAL, "step1")
