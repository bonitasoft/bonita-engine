class Deps {
    ...
    public static String springVersion = "5.3.19"
    public static String springBootVersion = "2.6.6"
    ...
    public static String commonsLangVersion = "3.12.0"
    ...
    public static String hibernateVersion = "5.6.7.Final"
