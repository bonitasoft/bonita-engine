class Deps {
    ...
    public static String bonitaArtifactsModelVersion = "1.0.1"
    ...
    public static String commonsLangVersion = "3.20.0"
    public static String commonsTextVersion = "1.15.0"
    public static String commonsDbcp2Version = "2.5.0"
    public static String commonsCLIVersion = "1.4"
    public static String commonsValidatorVersion = "1.10.1"
    ...
    public static String jacksonBomVersion = "2.13.4.20221013"
    ...
    public static String ehcacheVersion = "2.10.10.24.8"
    ...
    public static String mssqlVersion = "12.6.5.jre11"
    public static String oracleVersion = "23.26.0.0.0"
    public static String postgresqlVersion = "42.7.8"
