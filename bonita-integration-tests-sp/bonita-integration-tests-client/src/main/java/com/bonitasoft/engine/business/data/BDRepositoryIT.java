...
public class BDRepositoryIT extends CommonAPISPIT {
    ...
    public void deploying_bdm_after_process_should_put_process_in_resolved_state() throws Exception {
        ...
        installBusinessDataModel(buildSimpleBom(aQualifiedName));
    ...
    public void shouldBeAbleToRunDAOCallThroughGroovy() throws Exception {
        ...
        final String lastNameEmployee1 = "Boudin";
        final Expression employee1Expression = new ExpressionBuilder().createGroovyScriptExpression("createNewEmployee", "import " + EMPLOYEE_QUALIF_CLASSNAME
                + "; import org.bonita.pojo.Address; Employee e = new Employee(); e.firstName = '" + firstNameEmployee1 + "'; e.lastName = '" + lastNameEmployee1
    ...
    private String getClientBdmJarClassPath(final String bonitaHomePath) {
        return new StringBuilder().append(bonitaHomePath).append(File.separator).append("server").append(File.separator).append("tenants")
    ...
    public void should_execute_a_connector_with_tenant_dependency() throws Exception {
        ...
        builder.addConnectorImplementation(getResource("/com/bonitasoft/engine/business/data/TestConnectorInJar.impl", "TestConnectorInJar.impl"));
        builder.addClasspathResource(getResource("/com/bonitasoft/engine/business/data/test-connector-with-bdm-0.0.1-SNAPSHOT.jar.bak",
                "test-connector-with-bdm-0.0.1-SNAPSHOT.jar"));
